...
final readonly class SOXPerformanceMonitor implements SOXPerformanceMonitorInterface
{
    ...
    public function getMetrics(
        ...
        return new SOXPerformanceMetrics(
            ...
            p50LatencyMs: $latencyPercentiles['p50'] ?? 0.0,
            p95LatencyMs: $latencyPercentiles['p95'] ?? 0.0,
            p99LatencyMs: $latencyPercentiles['p99'] ?? 0.0,
            averageLatencyMs: $latencyPercentiles['average'] ?? 0.0,
            breakdownByControlPoint: $breakdownByControl,
        );
    }
