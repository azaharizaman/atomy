 ...
 */
final readonly class UpdateVendorLedgerOnPayment
{
    ...
    {
        // In a real implementation, this would look up the allocated amount
        // For now, divide evenly (simplified)
        $invoiceCount = count($event->vendorBillIds);
        if ($invoiceCount === 0) {
            return 0;
        }

        return (int) ($event->totalAmountCents / $invoiceCount);
    }
