...
```bash
composer require nexus/domain-identity:"*@dev"
```
...
use Nexus\Domain\Identity\Contracts\{
...
class IdentityServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(\Nexus\Domain\Identity\Services\UserManager::class);
        $this->app->singleton(\Nexus\Domain\Identity\Services\AuthenticationService::class);
        $this->app->singleton(\Nexus\Domain\Identity\Services\PermissionChecker::class);
        $this->app->singleton(\Nexus\Domain\Identity\Services\RoleManager::class);
        $this->app->singleton(\Nexus\Domain\Identity\Services\PermissionManager::class);
        $this->app->singleton(\Nexus\Domain\Identity\Services\MfaEnrollmentService::class);
        $this->app->singleton(\Nexus\Domain\Identity\Services\MfaVerificationService::class);
    }
}
```
...
```php
use Nexus\Domain\Identity\Services\AuthenticationService;
use Nexus\Domain\Identity\ValueObjects\Credentials;
use Nexus\Domain\Identity\Exceptions\InvalidCredentialsException;
use Nexus\Domain\Identity\Exceptions\AccountLockedException;
...
```php
use Nexus\Domain\Identity\Services\PermissionChecker;
use Nexus\Domain\Identity\Exceptions\InsufficientPermissionsException;
...
```php
use Nexus\Domain\Identity\Services\MfaEnrollmentService;
...
**Error:**
```
Target [Nexus\Domain\Identity\Contracts\UserRepositoryInterface] is not instantiable.
```
