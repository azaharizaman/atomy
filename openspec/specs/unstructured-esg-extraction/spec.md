# Capability: Unstructured ESG Extraction

## Purpose
TBD: Using NLP/LLMs to parse environmental permits, energy contracts, and utility invoices into structured ESG metrics.
