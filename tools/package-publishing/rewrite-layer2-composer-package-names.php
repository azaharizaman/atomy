...
$manifestPath = $root . '/docs/package-publishing/nexus-layer2-packages.manifest.json';
$write = in_array('--write', $argv, true);

if (! is_file($manifestPath)) {
    fwrite(STDERR, "Missing manifest. Run tools/package-publishing/build-layer2-manifest.php first.\n");
    exit(1);
}
