...
```php
use Nexus\Domain\Identity\Services\UserManager;
...
```php
use Nexus\Domain\Identity\Services\RoleManager;
...
```php
use Nexus\Domain\Identity\Services\PermissionManager;
...
```php
use Nexus\Domain\Identity\ValueObjects\Permission;
...
This package addresses all requirements listed in REQUIREMENTS.csv for `Nexus\Domain\Identity`:
