...
| `Nexus\Domain\Identity` | Maintainability Requirement | MAINT-IDE-1429 | Framework-agnostic core with zero Laravel dependencies in packages/domain/Identity/src/ |  |  |  |  |
