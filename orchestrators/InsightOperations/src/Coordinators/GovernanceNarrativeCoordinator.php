    ...
    private function cacheKey(
        ...
        return self::FEATURE_KEY .
            ...
            hash(
                "sha256",
                json_encode(
                    [$tenantId, $vendorId, $sourceFactsHash],
                    JSON_THROW_ON_ERROR,
                ),
            );
    }
